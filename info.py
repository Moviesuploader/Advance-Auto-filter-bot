...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Deendayal_Dhakad1/56')
...
URL = "https://multiple-albertine-deendayalautofilterbot.koyeb.app".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://multiple-albertine-deendayalautofilterbot.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://multiple-albertine-deendayalautofilterbot.koyeb.app/".format(FQDN)
else:
    URL = "https://multiple-albertine-deendayalautofilterbot.koyeb.app/".format(FQDN)
