...
PICS = (environ.get('PICS', 'https://telegram.me/share/url?url=https://graph.org/file/d7c97672c0c73e2824683.jpg')).split() #SAMPLE PIC
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001725191512')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001725191512')
...
URL = "https://auto-filter-bot-vszi.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://auto-filter-bot-vszi.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://auto-filter-bot-vszi.onrender.com/".format(FQDN)
else:
    URL = "https://auto-filter-bot-vszi.onrender.com/".format(FQDN)
