...
URL = "https://deendayaldhakad-ed26c81aee4c.herokuapp.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://deendayaldhakad-ed26c81aee4c.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://deendayaldhakad-ed26c81aee4c.herokuapp.com/".format(FQDN)
else:
    URL = "https://deendayaldhakad-ed26c81aee4c.herokuapp.com/".format(FQDN)
