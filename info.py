...
URL = "https://auto-filter-bot-puun.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://auto-filter-bot-puun.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://auto-filter-bot-puun.onrender.com/".format(FQDN)
else:
    URL = "https://auto-filter-bot-puun.onrender.com/".format(FQDN)
