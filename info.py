...
URL = "https://auto-filter-bot-sdpk.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://auto-filter-bot-sdpk.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://auto-filter-bot-sdpk.onrender.com/".format(FQDN)
else:
    URL = "https://auto-filter-bot-sdpk.onrender.com/".format(FQDN)
