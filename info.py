...
TUTORIAL = environ.get('TUTORIAL', 'https://youtu.be/0bZRpUosfEI?si=hyFd7kS25G2JstuQ')
...
URL = "https://deendayal-538030e57eef.herokuapp.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://deendayal-538030e57eef.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://deendayal-538030e57eef.herokuapp.com/".format(FQDN)
else:
    URL = "https://deendayal-538030e57eef.herokuapp.com/".format(FQDN)
