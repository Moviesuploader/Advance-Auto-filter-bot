...
URL = "https://deendayal-241556bf864d.herokuapp.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://deendayal-241556bf864d.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://deendayal-241556bf864d.herokuapp.com/".format(FQDN)
else:
    URL = "https://deendayal-241556bf864d.herokuapp.com/".format(FQDN)
