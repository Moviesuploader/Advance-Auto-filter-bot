...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Deendayal_Dhakad1/61')
...
URL = "https://deendayaldhakad-deendayaldhakad1.koyeb.app".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://deendayaldhakad-deendayaldhakad1.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://deendayaldhakad-deendayaldhakad1.koyeb.app/".format(FQDN)
else:
    URL = "https://deendayaldhakad-deendayaldhakad1.koyeb.app/".format(FQDN)
