...
URL = "https://popular-nadean-deendayal.koyeb.app".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://popular-nadean-deendayal.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://popular-nadean-deendayal.koyeb.app/".format(FQDN)
else:
    URL = "https://popular-nadean-deendayal.koyeb.app/".format(FQDN)
