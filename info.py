...
URL = "https://aware-lotti-deendayaldhakad1.koyeb.app".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://aware-lotti-deendayaldhakad1.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://aware-lotti-deendayaldhakad1.koyeb.app/".format(FQDN)
else:
    URL = "https://aware-lotti-deendayaldhakad1.koyeb.app/".format(FQDN)
