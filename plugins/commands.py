    ...
    if data.split("-", 1)[0] == "BATCH":
        ...
        if is_valid == True:
            await message.reply_text(
                text=f"<b>Hey {message.from_user.mention}, You are successfully 「 ✔ ᵛᵉʳᶦᶠᶦᵉᵈ 」⛥⛧ !\nNow you have unlimited access for all movies till today midnight.</b>",
                protect_content=True
            )
...
async def shortlink(bot, message):
    ...
    chat_type = message.chat.type
    if chat_type == enums.ChatType.PRIVATE:
        return await message.reply_text(f"<b>Hey {message.from_user.mention}, This command only works on groups !\n\n<u>Follow These Steps to Connect Shortener:</u>\n\n1. Add Me in Your Group with Full Admin Rights\n\n2. After Adding in Grp, Set your Shortener\n\nSend this command in your group\n\n—> /shortlink ""{your_shortener_website_name} {your_shortener_api}\n\n#Sample:-\n/shortlink bindaaslinks.com f0407e59364af78f5210a8dab52e859ee0a93e10\n\nThat's it!!! Enjoy Earning Money 💲\n\n[[[ Trusted Earning Site - http://bindaaslinks.com]]]\n\nIf you have any Doubts, Feel Free to Ask me - @Beautyofsupportbot\n\n(Puriyala na intha contact la message pannunga - @Beautyofsupportbot)</b>")
    elif chat_type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
    ...
    try:
        ...
        return await message.reply_text("<b>Command Incomplete :(\n\nGive me a shortener website link and api along with the command !\n\nFormat: <code>/shortlink bindaaslinks.com f0407e59364af78f5210a8dab52e859ee0a93e10</code></b>")
